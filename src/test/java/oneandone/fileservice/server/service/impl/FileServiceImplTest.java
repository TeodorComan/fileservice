...
public class FileServiceImplTest {
    ...
    @Before
    public void setup() {
        ReflectionTestUtils.setField(fileService, "rootFolderPath", "rootFolderPathValue");
        ReflectionTestUtils.setField(fileService, "backupFolderName", "backupFolderNameValue");
        fileService.init();
